...
$$
由 $4\in I$ 得 $2\in K$，且 $(2)K=I$。因为 $(2)$ 是主理想，$I$ 和 $K$ 在类群中代表同一类。由 C.2 的“包含 $2$”分类可知 $[I]=1$ 或 $[I]=A_{13}$。
